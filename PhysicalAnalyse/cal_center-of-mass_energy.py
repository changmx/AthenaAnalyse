...
def cal_2particle_centerOfMass_energy(m1_statistic, E1_total_energy, m2_statistic, E2_total_energy):
    '''
...
if __name__ == '__main__':
    ...
    E1_total_energy = 20e9
    E2_total_energy = 3.5e9

    E_cm = cal_2particle_centerOfMass_energy(
        m1_statistic, E1_total_energy, m2_statistic, E2_total_energy)
